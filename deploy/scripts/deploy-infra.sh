...
# ============================================================================
# NOTE: OCI cloud-network ingress for the public proxy port (3484) is NO LONGER
# opened from inside the deploy. The in-instance OCI CLI install + instance-
# principal automation was removed because it required a tenancy-level IAM
# dynamic-group + policy that is brittle to maintain and often unavailable.
#
# Enable the VCN Security List ingress rule for TCP 3484 from your workstation
# instead, using your own (already-configured) local OCI CLI:
#     deploy/scripts/enable-oci-ingress.sh    (bash/macOS/Linux/WSL)
#     deploy/enable-oci-ingress.ps1           (Windows PowerShell)
# See README -> "Cloud-network ingress (port 3484)".
# ============================================================================
